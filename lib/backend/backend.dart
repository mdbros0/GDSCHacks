...
import 'schema/dining_halls_record.dart';
...
export 'schema/dining_halls_record.dart';
...
/// Functions to query DiningHallsRecords (as a Stream and as a Future).
Future<int> queryDiningHallsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DiningHallsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DiningHallsRecord>> queryDiningHallsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DiningHallsRecord.collection,
      DiningHallsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DiningHallsRecord>> queryDiningHallsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
