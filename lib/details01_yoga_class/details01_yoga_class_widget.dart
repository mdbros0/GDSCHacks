...
class Details01YogaClassWidget extends StatefulWidget {
  const Details01YogaClassWidget({
    super.key,
    required this.diningDef,
  });

  final DocumentReference? diningDef;
...
class _Details01YogaClassWidgetState extends State<Details01YogaClassWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DiningHallsRecord>(
      stream: DiningHallsRecord.getDocument(widget.diningDef!),
      builder: (context, snapshot) {
        ...
        final details01YogaClassDiningHallsRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
          appBar: AppBar(
              ...
              children: [
                Padding(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.network(
                      details01YogaClassDiningHallsRecord.image,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        details01YogaClassDiningHallsRecord.name,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              dateTimeFormat('jm',
                                  details01YogaClassDiningHallsRecord.open!),
                              style: FlutterFlowTheme.of(context)
                                  .titleMedium
                                  .override(
                                    fontFamily: 'Readex Pro',
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 8.0, 5.0, 8.0),
                            child: Text(
                              'Open until ${dateTimeFormat('jm', details01YogaClassDiningHallsRecord.close)}',
                              style: FlutterFlowTheme.of(context)
                                  .titleMedium
                                  .override(
                                    fontFamily: 'Readex Pro',
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${listViewMenuItemsRecord.price.toString()}\$',
