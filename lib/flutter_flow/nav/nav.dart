      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => Details01YogaClassWidget(
            diningDef: params.getParam(
              'diningDef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['DiningHalls'],
            ),
          ),
        ),
        FFRoute(
          name: 'List13PropertyListviewCopy',
          path: '/list13PropertyListviewCopy',
          builder: (context, params) => const List13PropertyListviewCopyWidget(),
        )
